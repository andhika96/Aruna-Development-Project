...
class ARUNA_Form_validation {
	...
	/**
	 * Reference to the Aruna instance
	 *
	 * @var object
	 */
	...
	public function set_rules($field, $label = '', $rules = array(), $errors = array())
	{
		...
		if ($this->Aruna->input->method() !== 'post' && empty($this->validation_data))
		{
			return $this;
		}
	...
	{
		if ( ! file_exists($file_path = APPPATH.'config/validation.php')) 
		{
			show_error('Missing file config validation.');
		}

		include APPPATH.'config/validation.php';
	...
	{
		return $this->Aruna->input->valid_ip($ip, $which);
	}
