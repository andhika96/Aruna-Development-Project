...
class ARUNA_Session {
	...
	protected function _ci_load_classes($driver)
	{
		...
		// Allow custom drivers without the ARUNA_ or CS_ prefix
	...
	protected function _configure(&$params)
	{
		...
		isset($params['cookie_samesite']) OR $params['cookie_samesite'] = ucfirst(config_item('cookie_samesite'));
		...
		ini_set('session.cookie_samesite', $params['cookie_samesite']);
		session_set_cookie_params($get_params);
	 ...
	 * Session destroy
	 *
	 * Legacy ARUNA_Session compatibility method
	 *
	 * @return	void
	 */
