<?php
	...
	*/
	...
	| Set Header Cache
	|--------------------------------------------------------------------------
	| Customize set header cache
	*/

	$config['set_header_cache'] = FALSE;
	$config['set_header_cache_expire'] = 60;

	/*
	|--------------------------------------------------------------------------
	| Database Library Settings
	|--------------------------------------------------------------------------
	| You can choose database library from Aruna Framework or Codeigniter
	| If you want to using database library from Codeigniter, just change from Aruna to Codeigniter
	|
	...
	| $this->db->foo()
	|
	| Karena penggunaan $this->db->foo() sudah digunakan untuk database_library
	|
	*/
