...
class Format
{
    ...
    public function __construct($data = null, $from_type = null)
    {
        ...
        $this->_Aruna = &get_instance();

        // Load the inflector helper
        $this->_Aruna->load->extension('inflector');
    ...
    public function to_html($data = null)
    {
        ...
        $this->_Aruna->load->library('table');

        $this->_Aruna->table->set_heading($headings);
        ...
        foreach ($data as $row) {
            ...
            $this->_Aruna->table->add_row($row);
        }

        return $this->_Aruna->table->generate();
    }
    ...
    public function to_json($data = null)
    {
        ...
        $callback = $this->_Aruna->input->get('callback');
